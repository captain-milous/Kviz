...
namespace Kviz
{
    public class Program
    {
        ...
        static void AdminPanel(User user)
        {
            int input = 0;
            bool run = true;
            int strike = 0;
        ...
        #endregion
        #region QUIZ - Play, Import and Export
        ...
        #endregion
        #region QUIZ Manager
        static void QuizManager(User user)
        {
            Quiz quiz = new Quiz();
            int input = 0;
            bool run = true;
            ...
            while (run)
            {
                ...
                switch (input)
                {
                    ...
                    case 3:
                        quiz = ChooseQuiz();
                        if(user.Name == quiz.Autor.Name)
                        {
                            EditQuiz(quiz);
                        } 
                        else
                        {
                            Console.WriteLine("Nemůžete editovat kvízy někoho jiného.");
                            strike++;
                        }                        
                        break;
                    case 4:
                        ...
                        {
                            Console.WriteLine("Nemůžete smazat kvíz někoho jiného.");
                            strike++;
                        }
                        break;
                    case 5:
            ...
            while (run)
            {
                ...
                switch (input)
                {
                    ...
                    case 4:
                        ...
                        {
                            Console.WriteLine();
                            Console.Write("Vyberte číslo otázky z nabídky: ");
                            try
                            {
                                input = Convert.ToInt32(Console.ReadLine());
                            }
                            ...
                            if (input > 0 && input <= quiz.Questions.Count)
                            {
                                input = input - 1;
                                quiz.Questions.RemoveAt(input);
                                run = false;
                            }
                            else if (input == 0)
                            {
        ...
        #endregion
        #region Users
        static void UserManager(User user)
        {
            int input = 0;
            bool run = true;
            int strike = 0;
            ...
            while (run)
            {
                ...
                switch (input)
                {
                    case 1:
                        ...
                        {
                            Console.WriteLine(i+". "+u.ToString());
                            i++;
                        }
                        Console.WriteLine();
                        break;
                    ...
                    case 3:
                        ...
                        chosenUser = new User();
                        //User newUser = EditUser(chosenUser);
                        break;
                    case 4:
                        chosenUser = new User();
                        Console.WriteLine("In progress..");
